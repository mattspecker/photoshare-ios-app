...
(function() {
    ...
    class EventPhotoPickerService {
        ...
        /**
         * Shows event information modal with permissions status
         * @param {Object} options - Event information
         * @param {string} options.eventName - The event name
         * @param {string} options.memberId - The member ID
         * @param {string} options.eventId - The event ID
         * @param {string} options.startDate - ISO8601 start date
         * @param {string} options.endDate - ISO8601 end date
         * @returns {Promise<Object>} Event info and permission status
         */
        async showEventInfo(options = {}) {
            if (!this.isAvailable) {
            ...
            console.log(`📋 Showing event info for: ${eventName}`);
            
            try {
                const result = await this.plugin.showEventInfo({
                    eventName,
                    memberId,
                    eventId,
                    startDate,
                ...
                console.log('✅ Event info displayed successfully');
                return result;
            } catch (error) {
