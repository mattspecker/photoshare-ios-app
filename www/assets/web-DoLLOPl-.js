import{cF as m,cG as y,cH as T,cI as P,cJ as ee,cK as _e,cL as M,cM as Ne,cN as Ce,cO as De,cP as v,cQ as Oe,cR as A,bV as Re}from"./index-PUmVADdG.js";const te="@firebase/installations",F="0.6.19";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye="firebase-installations-database",ze=1,g="firebase-installations-store";let E=null;function K(){return E||(E=M(Ye,ze,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(g)}}})),E}async function k(e,t){const n=I(e),o=(await K()).transaction(g,"readwrite"),r=o.objectStore(g),s=await r.get(n);return await r.put(t,n),await o.done,(!s||s.fid!==t.fid)&&le(e,t.fid),t}async function we(e){const t=I(e),i=(await K()).transaction(g,"readwrite");await i.objectStore(g).delete(t),await i.done}async function S(e,t){const n=I(e),o=(await K()).transaction(g,"readwrite"),r=o.objectStore(g),s=await r.get(n),c=t(s);return c===void 0?await r.delete(n):await r.put(c,n),await o.done,c&&(!s||s.fid!==c.fid)&&le(e,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mt="/firebase-messaging-sw.js",yt="/firebase-cloud-messaging-push-scope",ye="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",Tt="https://fcmregistrations.googleapis.com/v1",Te="google.c.a.c_id",kt="google.c.a.c_l",vt="google.c.a.ts",It="google.c.a.e",G=1e4;var J;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(J||(J={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yt(e,t,n){const i=zt(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:n[Te],message_name:n[kt],message_time:n[vt],message_device_time:Math.floor(Date.now()/1e3)})}function zt(e){switch(e){case b.NOTIFICATION_CLICKED:return"notification_open";case b.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qt(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===b.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(Q(n)):e.onMessageHandler.next(Q(n)));const i=n.data;Bt(i)&&i[It]==="1"&&await Yt(e,n.messageType,i)}const X="@firebase/messaging",Z="0.12.23";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
